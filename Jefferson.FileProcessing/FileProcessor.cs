...
namespace Jefferson.FileProcessing
{
       ...
       where TSelf : FileProcessor<TSelf, TContext>
    {
        ...
        public FileProcessor(TContext context, IDirective[] directives = null)
        {
            ...
            mTemplateParser = BuildTemplateParser(directives);
        }
        ...
        protected virtual TemplateParser BuildTemplateParser(IDirective[] directives = null)
        {
            var jefferson = directives == null ? new TemplateParser() : new TemplateParser(directives);
